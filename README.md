...
Status as of 2026-06-05: **paused / research archive**. The real stock behavior moved to `real-stock-alert`, which now handles the real stock bucket and bot-only comparison. This repo is kept only for historical May paper-pilot records and manual research reruns.
...
- As of the 2026-06-05 inspection, TQQQ is open with `35.3032` shares at `$83.84` average cost and `$4.80` residual cash.
