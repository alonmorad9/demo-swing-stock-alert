...
- Treat the selected real-stock setup as RS63-heavy scoring, 8% ATR fresh-buy cap, two-week rank confirmation, no fixed timeout, weekly-only routine Telegram reports, and silent opening/daily checks except real sell alerts.
